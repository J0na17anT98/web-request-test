...
//  web-request-test
//
//  Created by Jonathan Tsistinas on 5/12/16.
...
class ViewController: UIViewController {
    ...
    @IBAction func TechNews(sender: AnyObject) {
        loadRequest("http://www.makeuseof.com/tag/google-flash-default-netflix-bad-health-tech-news-digest/")
